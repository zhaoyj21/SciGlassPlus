...
def process_springer(path,txtpath,logpath):
    ...
    for dir0 in dirlist:
        ...
        if os.path.isdir(path+dir0):
            ...
            #doc['file']=file
            doc['doi']=doi
            doc['content']=parser('D:/glass-total-results/html_springer/',dir0+'.html','springer',doi).sections
            doc['tables']=tables
            doc_dict[doi]=doc
    log.close()
...
def process_wiley():
    global log,iflog
    iflog=1
    path='E:/Data/Literature Data/AM fatigue html/wiley/'
...
def process_mdpi():
    global log,iflog
    iflog=1
    path='E:/Data/Literature Data/AM fatigue html/mdpi/'
    logpath=path+'parse.log'
    doi_dict=get_doi_dict()
    filelist=os.listdir(path)
    doc_dict={}
...
global log,iflog
iflog=0
#path='D:/glass/html_springer/table/'
#logpath=path+'parse.log'
#txtpath="D:/glass/html_springer/table/"
path='D:/glass-total-results/html_springer/table/'
logpath=path+'parse.log'
txtpath="D:/glass-total-results/html_springer/table/"
doc_dict=process_springer(path,txtpath,logpath)
# process_wiley()
# process_mdpi()
f=open(path+'springer_data_strcut_20241010.json','w',encoding='utf-8')
